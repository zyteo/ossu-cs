...
class Fraction(object):
    ...
    def __truediv__(self, other):
        # at first i used div but there was error, so changed to truediv
        # refer https://stackoverflow.com/questions/21692065/python-class-div-issue
    ...
    def reduce(self):
        """reduces fraction using gcd from math package"""
        divisor = gcd(self.num, self.denom)
        top = self.num / divisor
        bottom = self.denom / divisor
